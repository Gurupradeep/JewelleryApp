...
public class Dispatched_Order_adapter extends RecyclerView.Adapter<Dispatched_Order_adapter.PersonViewHolder> {
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private Dispatched_Order_adapter.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final Dispatched_Order_adapter.ClickListener clickListener) {
